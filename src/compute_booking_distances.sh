...
bq extract --destination_format=AVRO poc_analytics.WRK_BOOKINGS\$${RUN_DATE_NO_DASH} gs://poc-data-greengo/greengo/wrk_bookings/00*_0
...
gcloud dataproc jobs submit hive --cluster poc-data-greengo-m -f /home/hahavelka/greengo/src/SQL/WRK_BOOKINGS_DISTANCE.hql --params=RUN_DATE=${RUN_DATE}
